	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord8 = screenPos38;
						 ...
						 ) : SV_Target
			{
				...
				float4 screenPos38 = input.ase_texcoord8;
				...
				float distanceDepth38 = abs( ( screenDepth38 - LinearEyeDepth( ase_positionSSNorm.z,_ZBufferParams ) ) / ( _DepthDistance ) );
				...
				float4 appendResult330 = (float4(_NoiseScale3D.y , _NoiseScale3D.x , _NoiseScale3D.z , 0.0));
				float4 appendResult331 = (float4(_NoiseScale3D.y , _NoiseScale3D.z , _NoiseScale3D.x , 0.0));
				float4 transform70 = mul(GetObjectToWorldMatrix(),input.ase_texcoord9);
				float4 temp_output_71_0 = (transform70).xyzw;
				float simplePerlin3D112 = snoise( ( Scale228 * ( ( ( appendResult329 * break344.x ) + ( appendResult330 * break344.y ) + ( appendResult331 * break344.z ) ) * (temp_output_71_0*1.0 + float4( ( ( WindDir317 + _AdditionalNoiseDir ) * ( _NoiseSpeed * _TimeParameters.x * _WindSpeed ) ) , 0.0 )) ) ).xyz*_NoiseScale );
				simplePerlin3D112 = simplePerlin3D112*0.5 + 0.5;
				float temp_output_118_0 = saturate( (0.0 + (simplePerlin3D112 - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float4 ase_positionCS38 = TransformObjectToHClip( ( vertexPos38 ).xyz );
				float4 screenPos38 = ComputeScreenPos( ase_positionCS38 );
				output.ase_texcoord4 = screenPos38;
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float4 screenPos38 = input.ase_texcoord4;
				float4 ase_positionSSNorm = screenPos38 / screenPos38.w;
				ase_positionSSNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_positionSSNorm.z : ase_positionSSNorm.z * 0.5 + 0.5;
				float screenDepth38 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_positionSSNorm.xy ),_ZBufferParams);
				float distanceDepth38 = abs( ( screenDepth38 - LinearEyeDepth( ase_positionSSNorm.z,_ZBufferParams ) ) / ( _DepthDistance ) );
				...
				float4 appendResult330 = (float4(_NoiseScale3D.y , _NoiseScale3D.x , _NoiseScale3D.z , 0.0));
				float4 appendResult331 = (float4(_NoiseScale3D.y , _NoiseScale3D.z , _NoiseScale3D.x , 0.0));
				float4 transform70 = mul(GetObjectToWorldMatrix(),input.ase_texcoord5);
				float4 temp_output_71_0 = (transform70).xyzw;
				float simplePerlin3D112 = snoise( ( Scale228 * ( ( ( appendResult329 * break344.x ) + ( appendResult330 * break344.y ) + ( appendResult331 * break344.z ) ) * (temp_output_71_0*1.0 + float4( ( ( WindDir317 + _AdditionalNoiseDir ) * ( _NoiseSpeed * _TimeParameters.x * _WindSpeed ) ) , 0.0 )) ) ).xyz*_NoiseScale );
				simplePerlin3D112 = simplePerlin3D112*0.5 + 0.5;
				float temp_output_118_0 = saturate( (0.0 + (simplePerlin3D112 - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float4 ase_positionCS38 = TransformObjectToHClip( ( vertexPos38 ).xyz );
				float4 screenPos38 = ComputeScreenPos( ase_positionCS38 );
				output.ase_texcoord2 = screenPos38;
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float4 screenPos38 = input.ase_texcoord2;
				float4 ase_positionSSNorm = screenPos38 / screenPos38.w;
				ase_positionSSNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_positionSSNorm.z : ase_positionSSNorm.z * 0.5 + 0.5;
				float screenDepth38 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_positionSSNorm.xy ),_ZBufferParams);
				float distanceDepth38 = abs( ( screenDepth38 - LinearEyeDepth( ase_positionSSNorm.z,_ZBufferParams ) ) / ( _DepthDistance ) );
				...
				float4 appendResult330 = (float4(_NoiseScale3D.y , _NoiseScale3D.x , _NoiseScale3D.z , 0.0));
				float4 appendResult331 = (float4(_NoiseScale3D.y , _NoiseScale3D.z , _NoiseScale3D.x , 0.0));
				float4 transform70 = mul(GetObjectToWorldMatrix(),input.ase_texcoord3);
				float4 temp_output_71_0 = (transform70).xyzw;
				float simplePerlin3D112 = snoise( ( Scale228 * ( ( ( appendResult329 * break344.x ) + ( appendResult330 * break344.y ) + ( appendResult331 * break344.z ) ) * (temp_output_71_0*1.0 + float4( ( ( WindDir317 + _AdditionalNoiseDir ) * ( _NoiseSpeed * _TimeParameters.x * _WindSpeed ) ) , 0.0 )) ) ).xyz*_NoiseScale );
				simplePerlin3D112 = simplePerlin3D112*0.5 + 0.5;
				float temp_output_118_0 = saturate( (0.0 + (simplePerlin3D112 - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float4 ase_positionCS38 = TransformObjectToHClip( ( vertexPos38 ).xyz );
				float4 screenPos38 = ComputeScreenPos( ase_positionCS38 );
				output.ase_texcoord5 = screenPos38;
						 ...
						 ) : SV_Target
			{
				...
				float4 screenPos38 = input.ase_texcoord5;
				float4 ase_positionSSNorm = screenPos38 / screenPos38.w;
				ase_positionSSNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_positionSSNorm.z : ase_positionSSNorm.z * 0.5 + 0.5;
				float screenDepth38 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_positionSSNorm.xy ),_ZBufferParams);
				float distanceDepth38 = abs( ( screenDepth38 - LinearEyeDepth( ase_positionSSNorm.z,_ZBufferParams ) ) / ( _DepthDistance ) );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction(Attributes input  )
			{
				...
				float4 ase_positionCS38 = TransformObjectToHClip( ( vertexPos38 ).xyz );
				float4 screenPos38 = ComputeScreenPos( ase_positionCS38 );
				output.ase_texcoord = screenPos38;
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float4 screenPos38 = input.ase_texcoord;
				float4 ase_positionSSNorm = screenPos38 / screenPos38.w;
				ase_positionSSNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_positionSSNorm.z : ase_positionSSNorm.z * 0.5 + 0.5;
				float screenDepth38 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_positionSSNorm.xy ),_ZBufferParams);
				float distanceDepth38 = abs( ( screenDepth38 - LinearEyeDepth( ase_positionSSNorm.z,_ZBufferParams ) ) / ( _DepthDistance ) );
...
ASEEND*/
//CHKSM=F47E7F4D032C8DD02172056C34D7950D31233DE2